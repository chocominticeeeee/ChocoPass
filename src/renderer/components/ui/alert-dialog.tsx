...
/**
 * shadcn 風の AlertDialog（Radix ベース）。
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'glass-strong fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2',
        'animate-scale-in overflow-hidden rounded-2xl p-6 shadow-2xl shadow-black/60 focus:outline-none',
        className
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={buttonVariants({ variant: 'destructive', className })}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={buttonVariants({ variant: 'outline', className: cn('mt-2 sm:mt-0', className) })}
    {...props}
  />
));
