      ...
      <form onSubmit={submit} className="w-full max-w-sm animate-fade-in">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="relative mb-5 h-20 w-20">
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-neon-cyan to-neon-violet blur-xl opacity-60 animate-glow-pulse" />
            <div className="relative flex h-full w-full items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 to-violet-500 shadow-2xl">
              <ShieldCheck className="h-10 w-10 text-slate-950" strokeWidth={2.2} />
            </div>
          </div>
